...
INSERT INTO post (added, text, author_username, id, image) VALUES
                                                               ('2024-01-06T12:00:00', 'Text of the post 1', 'user1', 1, oid(16943)),
                                                               ('2024-01-06T12:00:00', 'Text of the post 2', 'user1', 0, oid(16944)),
                                                               ('2024-01-06T12:00:00', 'Text of the post 3', 'user2', 0, oid(16945)),
                                                               ('2024-01-06T12:00:00', 'Text of the post 4', 'user3', 0, oid(16946)),
                                                               ('2024-01-06T12:00:00', 'Text of the post 5', 'user4', 0, oid(16943)),
                                                               ('2024-01-06T12:00:00', 'Text of the post 6', 'user4', 1, oid(16944)),
                                                               ('2024-01-06T12:00:00', 'Text of the post 7', 'user5', 0, oid(16945)),
                                                               ('2024-01-06T12:00:00', 'Text of the post 8', 'user5', 1, oid(16946));
